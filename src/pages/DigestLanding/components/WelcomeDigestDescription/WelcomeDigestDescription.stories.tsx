...
export const LongText: Story = {
  args: {
    text: "Дайджест — це цілий рік пропозицій для здоровʼя, знижок на медичні послуги та товари для здоров’я, корисний контент, щоб ви могли піклуватись про свій організм комфортно та без зайвих зусиль.це цілий рік пропозицій для здоровʼя, знижок на медичні послуги та товари для здоров’я, корисний контент, щоб ви могли піклуватись про свій організм комфортно та без зайвих зусиль.це цілий рік пропозицій для здоровʼя, знижок на медичні послуги та товари для здоров’я, корисний контент, щоб ви могли піклуватись про свій організм комфортно та без зайвих зусиль.це цілий рік пропозицій для здоровʼя, знижок на медичні послуги та товари для здоров’я, корисний контент, щоб ви могли піклуватись про свій організм комфортно та без зайвих зусиль.",
  },
};